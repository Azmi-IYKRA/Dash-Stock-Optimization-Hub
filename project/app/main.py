...
# from models.pulp_solver import pulp_solver
import os
...
app.layout = dbc.Container(
            ...
            children=[
                ...
                children=[
                    dcc.Dropdown(
                        ...
                        options=[
                        {'label': html.Span(['Sort by Top 10 Highest Overstock Cost Product'], style={'color': 'whitesmoke', 'align':'left'}), 'value': 'Overstock Cost'},
                        {'label': html.Span(['Sort by Top 10 Highest Stockout Ratio Product'], style={'color': 'whitesmoke', 'align':'left'}), 'value': 'Stockout Ratio'},
                        {'label': html.Span(['Sort by Top 10 Slowest Inventory Turnover Product'], style={'color': 'whitesmoke', 'align':'left'}), 'value': 'ITR'}
                        ],
    ...
    # Tombol untuk membuka/meminimalkan chatbot
        html.Div(
            html.Button("🤖 Chat-Bot", id="toggle-chat", style={"borderRadius": "30px", "width": "130px", "height": "50px", "backgroundColor": "#406abd", "color": "white","border": "2px solid white"}),
            style={"position": "fixed", "bottom": "20px", "right": "20px", "zIndex": "1000"}
        ),
        html.Div(id="chat-window", children = chatbox(),style={'display': 'none',"bottom": "105px", "right": "20px", "position": "fixed", "zIndex": "1000", 'font-size':12, "width":"800px"}),
    ]),
    # Tablest
    html.Br(),
    dbc.Col(
        ...
        children=[
            dbc.Card(
                ...
                children=[
                    dbc.CardHeader(
                        dbc.Row([
                            dbc.Col(html.H5("Current Stock Monitor"), width="auto", style={"margin-right": "1000px"}),  # Header
                            dbc.Col(
                                dbc.Button(
                                    "Show/Hide Table",
                                    id="toggle-stock-table",
                    ...
                    dbc.Collapse(
                        id="stock-table-collapse",
                        is_open=True,  # Default ditampilkan
                        children=[
                            dbc.CardBody(
                                class_name='stockout-ratio-line-card-body card-body m-1',
                                children=[
        ...
        children=[
            dbc.Card(
                ...
                children=[
                    dbc.CardHeader(
                        dbc.Row([
                            dbc.Col(html.H5("Stock Optimization Plan"), width="auto", style={"margin-right": "67px"}),  # Header
                            dbc.Col(
                                dbc.Button(
                                    "Show/Hide Table",
                                    id="toggle-stock-optim",
                                    className="button toggle-button",
                                    n_clicks=0,
                                    style={"margin-left": "10px"}
                                ),
    ...
    # html.Br(),
    # dbc.Row([
    #     dbc.Col(html.H4("Current Stock Pivot"), width="auto"),  # Header
    #     dbc.Col(
    #         dbc.Button(
    #             "Save as Excel",
    #             id="save-button-stock-pivot",
    ...
    dbc.Row([
        dbc.Col([
            html.H6("Created by IYKRA", style={'margin':'10px'}),
            html.A(html.Img(src='assets/iykra.jpg', style={'height': '32px'}), 
                href="https://www.iykra.com/about/id",
                target="_blank")                      
...
#tablestoutput
@app.callback(
    Output("stock-table-collapse", "is_open"),
    Input("toggle-stock-table", "n_clicks"),
    State("stock-table-collapse", "is_open"),
)
...
@app.callback(
    ...
    Input("toggle-stock-optim", "n_clicks"),
    State("stock-optim-collapse", "is_open"),
)
def toggle_optim_table(n_clicks, is_open):
    if n_clicks:
        return not is_open
    return is_open
#tablestoutput
