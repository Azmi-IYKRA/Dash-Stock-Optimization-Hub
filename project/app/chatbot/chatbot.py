    ...
    return dbc.Container([
            ...
            dbc.Col([
                html.Div([
                    ...
                    html.Div(id="streaming-process", style={
                                                        ...
                                                        'textAlign': 'left', 'margin-left': '5px', 'font-size':20, 'width':250}),
                ], style={
                        'height': '500px', 'overflowY': 'scroll', 'border': '1px solid #ddd', 'padding': '10px', 'borderRadius': '10px',
                        'backgroundColor': '#30343c', 'marginBottom': '20px', 'font-size':15}),
        ...
        html.Div([
            html.Button('Send', id='send-button', n_clicks=0, style={
                'padding-left': '10px', 'padding-right': '10px','backgroundColor': '#007bff', 'border': 'none', 'color': 'white', 'borderRadius': '5px', 'height':'30px', 'padding-top': '5px',
        }),
        ], style={'display': 'flex','justifyContent': 'flex-end', 'padding': '10px'}),
    ], style={'width': '800px', 'margin': '0 auto', 'padding': '10px', 'border': '1px solid #ddd', 'borderRadius': '10px', 'fontFamily': 'Poppins', 'marginTop': '10px',
              "boxShadow": "0px 4px 6px rgba(0,0,0,0.1)", 'backgroundColor': '#202c34', 'font-size':13})
