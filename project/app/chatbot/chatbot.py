            ...
            dbc.Col([
                html.Div([
                    ...
                    html.Div(id="streaming-process", style={
                                                        ...
                                                        'textAlign': 'left', 'margin-left': '5px', 'font-size':15, 'width':800}),
                ], style={
                        'height': '500px', 'overflowY': 'scroll', 'border': '1px solid #ddd', 'padding': '8px', 'borderRadius': '10px',
                        'backgroundColor': '#30343c', 'marginBottom': '5px', 'font-size':15}),
